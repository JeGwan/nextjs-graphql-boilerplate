...
export class Formatter {
  static serial = (raw: string) => raw.toUpperCase().replace(/[^A-Z0-9]/g, "");
  ...
  // dayjs는 string | number | Date | Dayjs 파라미터를 받아서 Dayjs 객체를 리턴
  static isoToDayJS = (date: string) => dayjs(date);
  static phone = (value: string) => {
